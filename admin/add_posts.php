...
$vulgar_words = ["dhur", "fuck", "pakk"]; // Replace with actual words you want to filter

function contains_vulgar_words($content, $vulgar_words) {
...
if (isset($_POST['publish']) || isset($_POST['draft'])) {
    ...
    if (contains_vulgar_words($content, $vulgar_words)) {
        $message[] = 'Your post contains inappropriate language. Please revise it.';
    } else {
